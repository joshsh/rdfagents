 ...
 * Time: 7:08 PM
 */
public class SesameJadePlatform {
    private static final Logger LOGGER = Logger.getMyLogger(SesameJadePlatform.class.getName());
     ...
     * @param config
     */
    public SesameJadePlatform(final Configuration config) {
        this.config = config;
