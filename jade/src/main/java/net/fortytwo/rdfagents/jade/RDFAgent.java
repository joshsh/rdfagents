...
public class RDFAgent extends Agent {
    ...
    */
    ...
    public static class Wrapper {
        ...
        private final QueryServer<Value, Dataset> queryServer;

        public Wrapper(final AgentReference self,
                       final MessageFactory messageFactory,
                       final QueryServer<Value, Dataset> queryServer) {
            this.self = self;
        ...
        public void setAgent(final RDFAgent agent) {
            this.agent = agent;
        }
    }
